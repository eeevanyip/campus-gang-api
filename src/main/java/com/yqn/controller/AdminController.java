...
public class AdminController {
    ...
    public Map<String, Object> saveAdmin(Admin admin) {
        ...
        if (result) {
            return message.message(true, "Admin,添加成功");
        }
        return message.message(false, "Admin已存在,添加失败");
    }
    ...
    public Map<String, Object> delAdmin(@PathVariable Long id) {
        ...
        if (b) {
            return message.message(true, "Admin,删除成功");
        }
        return message.message(false, "Admin,删除失败");
    }
    ...
    public Map<String, Object> putadmin(Admin admin) {
        ...
        if (b) {
            return message.message(true, "Admin,更新信息成功");
        }
        return message.message(false, "Admin,更新信息失败");
    }
}
