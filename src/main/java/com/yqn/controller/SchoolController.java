...
public class SchoolController {
    ...
    public Map<String, Object> schools() {
        ...
        return message.message(true, schools);
    }
    ...
    public Map<String, Object> findSchoolsById(@PathVariable String id) {
        ...
        return message.message(true, school);
    }
    ...
    public Map<String, Object> saveSchool(School school) {
        ...
        if (save) {
            return message.message(true, "添加学校成功");
        }
        return message.message(false, "error,学校已存在");
    }
    ...
    public Map<String, Object> delSchool(@PathVariable Long id) {
        ...
        if (remove) {
            return message.message(true, "删除学校成功");
        }
        return message.message(false, "error,删除学校失败");
    }
    ...
    public Map<String, Object> putSchool(School school) {
        ...
        if (update) {
            return message.message(true, "更新学校信息成功");
        }
        return message.message(false, "error,更新学校信息失败");
    }
}
